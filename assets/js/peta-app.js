        ...
        L.popup()
            ...
            .setContent(
                `<b>Kepercayaan: </b>${kepercayaan}<br>
                            ...
                            <b>Radius Kemungkinan: </b>${radiusKemungkinan}<br>
                    ...
                    .then((data) => {
                        if ((urlParams.has('lat') && urlParams.has('long')) && !urlParams.has('all')) {
                            ...
                            try {
                                ...
                                dataPropertiHotspot += '<tr><th>Nama Kabupaten</th><td>:</td><td>' + dataSatuanHotspot[0].Perbaikan.namaKabupaten + '</td></tr>';
                                dataPropertiHotspot += '<tr><th>Nama Kecamatan</th><td>:</td><td>' + dataSatuanHotspot[0].Perbaikan.namaKecamatan + '</td></tr>';
                                dataPropertiHotspot += '<tr><th>Nama Kelurahan</th><td>:</td><td>' + dataSatuanHotspot[0].Perbaikan.namaKelurahan + '</td></tr>';
                                dataPropertiHotspot += '<tr><th>Tingkat Kepercayaan</th><td>:</td><td>' + dataSatuanHotspot[0].Asli.kepercayaan + '</td></tr>';
                                dataPropertiHotspot += '<tr><th>Radius Kemungkinan</th><td>:</td><td>' + dataSatuanHotspot[0].Asli.radiusKemungkinan + '</td></tr>';
                        ...
                        if (urlParams.has('all') && urlParams.get('all') == "true") {
                            ...
                            data.forEach(item => {
                                kabupatenList.add(item.Perbaikan.namaKabupaten);
                            });
                                ...
                                arrayData.forEach(item => {
                                    ...
                                    circleMarker.on(
                                        ...
                                        hotspotClicked(
                                            ...
                                            item.Asli.tanggal,
                                            item.Asli.waktu,
                                            item.Perbaikan.namaKabupaten,
                                            item.Perbaikan.namaKecamatan,
                                            item.Perbaikan.namaKelurahan,
                                            item.Asli.satelit,
                                            item.Asli.radiusKemungkinan
                                        )
                                    );
                                });
                            }
                            ...
                            document.getElementById('pilihanDaerah').addEventListener('change', function () {
                                ...
                                if (pilihanDaerah == "all") {
                                    ...
                                    dataDaerahSeleksi = [];
                                    data.forEach(item => {
                                        if (item.Perbaikan.namaKabupaten == pilihanDaerah) {
